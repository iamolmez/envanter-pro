      ...
      <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-xl animate-fade-in p-6">
        <div className="text-center">
          ...
          <p className="text-sm text-slate-500 mb-6">
            <strong className="text-slate-700">"{productName}"</strong> ürününü
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={onConfirm}
              disabled={loading}
              className="flex-1 px-4 py-2.5 rounded-xl bg-red-600 text-sm font-medium text-white hover:bg-red-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {loading && (
